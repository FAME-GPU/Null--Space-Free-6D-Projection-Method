...
%BUILD_MASS_BACKEND_EXP3 Scalar-isotropic Fourier mass backend.
%
% Production N=5 uses one universally exact radix rank-1 kernel.  A compact
% batch-FFT scalar backend is retained for quick small-N validation only.
